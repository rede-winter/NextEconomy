...
class ReflectionTitleAPI implements InternalTitleAPI {
    ...
    public List<Object> buildPackets(String message, int fadeIn, int stay, int fadeOut) {
        ...
        try {
            ...
            if (title != null) {
                Object e = getNMSClass("PacketPlayOutTitle")
                ...
                Object e2 = getNMSClass("PacketPlayOutTitle")
                        .getDeclaredClasses()[0]
                        .getField("TITLE")
                        .get(null);
                Object chatTitle2 = getNMSClass("IChatBaseComponent")
                        .getDeclaredClasses()[0]
                        .getMethod("a", new Class[] {String.class})
                        .invoke(null, "{\"text\":\"" + title + "\"}");
                Constructor<?> subtitleConstructor2 = getNMSClass("PacketPlayOutTitle")
                        .getConstructor(
                                getNMSClass("PacketPlayOutTitle").getDeclaredClasses()[0],
                                getNMSClass("IChatBaseComponent"));
            ...
            if (subtitle != null) {
                ...
                Object e2 = getNMSClass("PacketPlayOutTitle")
                        ...
                        .getField("SUBTITLE")
                        .get(null);
                Object chatSubtitle2 = getNMSClass("IChatBaseComponent")
                        .getDeclaredClasses()[0]
                        .getMethod("a", new Class[] {String.class})
