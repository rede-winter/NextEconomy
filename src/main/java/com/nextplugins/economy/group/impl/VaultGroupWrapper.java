...
public class VaultGroupWrapper implements GroupWrapper {
    ...
    private void setupPermission() {
        ...
        RegisteredServiceProvider<Permission> permissionProvider =
                NextEconomy.getInstance().getServer().getServicesManager().getRegistration(Permission.class);
    ...
    private void setupChat() {
        ...
        RegisteredServiceProvider<Chat> chatProvider =
                NextEconomy.getInstance().getServer().getServicesManager().getRegistration(Chat.class);
