package com.nextplugins.economy.model.storage;
...
public final class AccountStorage {
    ...
    public Account findAccount(@NotNull OfflinePlayer offlinePlayer) {
        ...
        return findAccountByName(
                nickMode ? offlinePlayer.getName() : offlinePlayer.getUniqueId().toString());
    }
    ...
    public Account findAccount(@NotNull Player player) {
        Account account = findAccountByName(
                nickMode ? player.getName() : player.getUniqueId().toString());
        if (account == null) {
